...
//        System.out.println("text: " + text);
        ...
        System.out.println("plusWeek: " + date.plusWeeks(4)); // плюс 4 недели
        ...
        System.out.println("год: " + date2.getYear() + "; месяц: " + date2.getMonth() + "; месяц-цифра: " +
                date2.getMonthValue());
...
//        }
        ...
        System.out.println(date3.getDayOfMonth() + ":" + date3.getMonthValue() + ":" + date3.getYear() + ":" +
                date3.getDayOfWeek());

        System.out.println("\n ================== LocalTime ====================");
        // LocalTime - представляет собой (часы, минуты, секунды, наносекунды)
        ...
        System.out.println("time.minusMinutes(30): " + time.minusMinutes(30));
        ...
        System.out.println("\n ======================= LocalDateTime =================== ");
        // LocaleDateTime представляет собой дату и время (без учета часового пояса)
        ...
        // возвращает он long
        long daysBetween = date4.until(date5, ChronoUnit.DAYS); // сколько дней между date 4 и date 5
        System.out.println("date4.until(date5, ChronoUnit.DAYS): " + daysBetween);

        LocalDateTime dateTime1 = LocalDateTime.now();
        LocalDateTime dateTime2 = dateTime1.plusDays(15);
        System.out.println(dateTime2.until(dateTime1, ChronoUnit.HOURS));

        // Универсальные методы minus, plus - ко всем объектам даты / времени
        LocalDateTime dateTime3 = dateTime1.minus(10, ChronoUnit.DAYS); // вычесть из дты 10 дней
        ...
        */
        ...
        System.out.println("\n =========== DateTimeFormatter ================ ");
        // DateTimeFormatter форматирование дат и времени
        ...
        h - часы в формате от 0 до 12
        m - минута
        s - секунда

        Количество повторений символа определяет формат
        yy - 2-х значный год, например 24 для 2024 года
