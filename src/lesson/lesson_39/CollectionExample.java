...
public class CollectionExample {
    public static void main(String[] args) {
        ...
        // Ссылка типа интерфейс -Ю а с права мы можем подставить объект разных классов (получить разные реализации этого интерфейса).
        ...
        */
        ...
        // boolean removeAll(Collection<?> c) - удаляет все элементы из коллекции вызова, содержащиеся в коллекции col (выситание)
        ...
        // boolean retailAll(Collection<?> col) - Оставляет в коллекции вызова только те элементы, которые содержаться в коллекции col
        // Удаляет из вызова элементы, которые НЕ содержаться в коллекции col - (пересечение)
