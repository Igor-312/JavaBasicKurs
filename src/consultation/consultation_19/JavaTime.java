package consultation.consultation_19;
...
//        Чаще всего используется для измерения коротких промежутков времени
        ...
        String strDate2 = "15-12-2022 20:46";
        DateTimeFormatter formatter2 = DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm");
        LocalDateTime date2 = LocalDateTime.parse(strDate2, formatter2);
        System.out.println(date2.getMonth() + " | " + date2.getDayOfWeek() + " | " + date2.getHour());
        ...
        String strDate1 = "30/01/23 1:47";
        DateTimeFormatter formatter3 = DateTimeFormatter.ofPattern("dd/MM/yy H:mm");
        LocalDateTime date1 = LocalDateTime.parse(strDate1, formatter3);
        System.out.println(date1.getMonth() + " | " + date1.getDayOfMonth() + " | " + date1.getHour());
    ...
    public static void task2(List<LocalDate> dates) {
        ...
        // Вычислить кол-во дней между этими датами (min, max)
